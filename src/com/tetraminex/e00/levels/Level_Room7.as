...
package com.tetraminex.e00.levels
{
	...
	public class Level_Room7 extends BaseLevel
	{
		//Embedded media...
		[Embed(source="mapCSV_Room7_Tiles.csv", mimeType="application/octet-stream")] public var CSV_Tiles:Class;
		[Embed(source="../../../../assets/images/tiles.png")] public var Img_Tiles:Class;
		[Embed(source="mapCSV_Room7_Walls.csv", mimeType="application/octet-stream")] public var CSV_Walls:Class;
		...
		public function Level_Room7(addToStage:Boolean = true, onAddCallback:Function = null, parentObject:Object = null)
		{
			// Generate maps.
		...
		{
			addSpriteToLayer(null, Hero, SpritesGroup , 180.000, 180.000, 0.000, 1, 1, false, 1.000, 1.000, generateProperties( null ), onAddCallback );//"Hero"
		}
